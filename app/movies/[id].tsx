            ...
            <ScrollView
                ...
                <View>
                    <Image
                        ...
                        resizeMode="stretch"
                        source={{uri: `https://image.tmdb.org/t/p/w500/${movie?.poster_path}.png`}}
                    />
                </View>
                ...
                <View className="flex-col items-start justify-center mt-5 px-5">
                    ...
                    <View
                        className="flex-row items-center justify-center bg-dark-100 px-2 py-1 rounded-md gap-x-1 mt-2">
